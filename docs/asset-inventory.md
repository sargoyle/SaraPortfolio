# Sara's Portfolio Asset Inventory
...
- `[x]` `public/images/about/profile.jpg`
...
- `[x]` `public/images/photography/Alien.png`
- `[x]` `public/images/photography/Kaleido Kitty.jpg`
- `[x]` `public/images/photography/Cats Eyes.jpg`
- `[x]` `public/images/photography/Gecko.png`
- `[x]` `public/images/photography/Mothman.png`
- `[x]` `public/images/photography/Xeno.png`
- `[x]` `public/images/photography/Abstract Macro 1.JPG`
- `[x]` `public/images/photography/Abstract Macro 2.JPG`
- `[x]` `public/images/photography/Abstract Macro 3.JPG`
- `[x]` `public/images/photography/Abstract Macro 4.JPG`
- `[x]` `public/images/photography/Abstract Macro 5.JPG`
- `[x]` `public/images/photography/Abstract Macro 6.JPG`
- `[x]` `public/images/photography/Abstract Macro 7.JPG`
- `[x]` `public/images/photography/Abstract Macro 8.JPG`
- `[x]` `public/images/photography/Abstract Macro 9.JPG`
- `[x]` `public/images/photography/Abstract Macro 10.JPG`
- `[x]` `public/images/photography/Abstract Macro 11.JPG`
- `[x]` `public/images/photography/Abstract Macro 12.JPG`
- `[x]` `public/images/photography/Abstract Macro 13.JPG`
...
3. Open every section and check the browser console for unintended image 404s.
4. Review card crops at desktop and mobile widths.
5. Review modal image sizing at desktop and mobile widths.
6. Update this inventory and `docs/tasks.md`.
