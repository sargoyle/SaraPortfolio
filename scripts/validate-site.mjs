...
check(styleText.includes('font-size: clamp(2.75rem, 4vw, 4.25rem);'), 'Tucked Away h1 should use the reduced desktop heading size.')
check(styleText.includes('font-size: clamp(2rem, 3vw, 3.1rem);'), 'Tucked Away h2 should use the reduced desktop section heading size.')
