...
check(/\.tucked-use-case-screenshot\s*\{[^}]*width:\s*min\(100%,\s*380px\)/s.test(styleText), 'Tucked Away Use cases setup screenshot should use the larger desktop width.')
